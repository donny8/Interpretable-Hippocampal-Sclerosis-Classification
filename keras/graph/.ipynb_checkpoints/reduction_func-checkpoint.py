...
def loader(SETT,TRIAL,AUG,KERNEL_SEED,LRMB):
    if(LRMB!='M'):
        yT = io.loadmat('/home/dokim_hdd/HS/01.HS_Project/graph/[%s%d%s%d]Y_true_%s.mat' %(SETT,TRIAL,AUG,KERNEL_SEED,LRMB))
        yP = io.loadmat('/home/dokim_hdd/HS/01.HS_Project/graph/[%s%d%s%d]yPrediction_%s.mat' %(SETT,TRIAL,AUG,KERNEL_SEED,LRMB))
        yL = io.loadmat('/home/dokim_hdd/HS/01.HS_Project/graph/[%s%d%s%d]yLabelPrediction_%s.mat' %(SETT,TRIAL,AUG,KERNEL_SEED,LRMB))
