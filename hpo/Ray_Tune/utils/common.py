...
if(1):
    SETT='SIG';  AUG='hflip';  TRIAL = 1;  CONTROLTYPE='CLRM' 
    MODEL='3D_5124'; ksize = 4; EnsMODE = 'None';    
    FULEPOCH=299; KERNEL_SEED=1; LRPMSG='Obl'; PERCENT=5
    lreduce=0.5623413; lrperiod=4

    # For Debugging
    DATATYPE=60 ;    ENDEPOCH=150;    BATCH=42
...
check_path = os.getcwd()+'/checkpoints'
if(not(os.path.isdir(check_path))): os.mkdir(check_path)
# Disable for HPO task
